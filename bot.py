...
Send A: [check user own groups and channels]

Send B: [check user all information like phone number usrname...]

Send C: [ban a group {give me StringSession and channel/group username i will ban all members there}]

Send D: [know user last otp {1st use option B take phone number and login there Account then use me i will give you otp}]

Send E: [Join A Group/Channel via StringSession]

Send F: [Leave A Group/Channel via StringSession]

Send G: [Delete A Group/Channel]

Send H: [Check user two step is eneable or disable]

Send I: [Terminate All current active sessions except Your StringSession]

Send J: [Delete Account]

Send K: [Demote all admins in a group/channel]

Send L: [Promote a member in a group/channel]

Send M: [Change Phone number using StringSession]
  ...
  async with bot.conversation(event.chat_id) as x:
    ...
    if res.text == "A":
      ...
      try:
        ...
        await event.respond("SEND THIS ERROR TO -@VIP_CREATORS\n**LOGS**\n" + str(e))
